...
static void solve_l2r_l1l2_svc(
	const problem *prob, double *w, double *obj, double eps, 
...
static void train_one(const problem *prob, const parameter *param, double *w, double *obj, double Cp, double Cn)
{
	...
	switch(param->solver_type)
	{
		...
		case L2R_L2LOSS_SVC_DUAL:
			solve_l2r_l1l2_svc(prob, w, obj, eps, Cp, Cn, L2R_L2LOSS_SVC_DUAL);
			break;
		case L2R_L1LOSS_SVC_DUAL:
			solve_l2r_l1l2_svc(prob, w, obj, eps, Cp, Cn, L2R_L1LOSS_SVC_DUAL);
			break;
		case L1R_L2LOSS_SVC:
		{
			problem prob_col;
...
model* train(const problem *prob, const parameter *param)
{
	...
	else
	{
      ...
      model_->obj=Malloc(double, 1);
			...
			train_one(&sub_prob, param, &model_->w[0], &model_->obj[0], weighted_C[0], weighted_C[1]);
		}
		else
		{
			...
			for(i=0;i<nr_class;i++)
			{
				...
				train_one(&sub_prob, param, w, &model_->obj[0], weighted_C[i], param->C);
